...
const ImagePuzzle: React.FC<ImagePuzzleProps> = ({ externalImage, level, puzzleId }) => {
  ...
  const BOARD_PX = Math.min(480, (typeof window !== 'undefined' ? window.innerWidth : 800) - 48);
            ...
            <div className="win-modal">
              ...
              <div className="modal-actions">
                ...
                <div className="modal-footer-actions">
                  <button className="btn btn-ghost btn-sm" onClick={() => router.push('/leaderboard')}>View Leaderboard</button>
                  <button className="btn btn-ghost btn-sm" onClick={handleChangeDifficulty}>Change Difficulty</button>
                  <button className="btn btn-ghost btn-sm" onClick={() => router.push(user ? '/dashboard' : '/')}>Go to Home</button>
                </div>
              </div>
            </div>
          </div>
